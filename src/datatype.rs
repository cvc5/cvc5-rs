...
impl DatatypeConstructorDecl {
    pub(crate) fn from_raw(raw: Cvc5DatatypeConstructorDecl) -> Self { Self { inner: raw } }
...
impl PartialEq for DatatypeConstructorDecl {
    fn eq(&self, other: &Self) -> bool { unsafe { cvc5_dt_cons_decl_is_equal(self.inner, other.inner) } }
}
impl Eq for DatatypeConstructorDecl {}

impl std::hash::Hash for DatatypeConstructorDecl {
    fn hash<H: std::hash::Hasher>(&self, state: &mut H) { unsafe { cvc5_dt_cons_decl_hash(self.inner) }.hash(state); }
}

impl fmt::Debug for DatatypeConstructorDecl {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result { write!(f, "DatatypeConstructorDecl({self})") }
}
...
impl DatatypeDecl {
    pub(crate) fn from_raw(raw: Cvc5DatatypeDecl) -> Self { Self { inner: raw } }
    ...
    pub fn num_constructors(&self) -> usize { unsafe { cvc5_dt_decl_get_num_constructors(self.inner) } }

    /// Return `true` if this datatype declaration is parametric.
    pub fn is_parametric(&self) -> bool { unsafe { cvc5_dt_decl_is_parametric(self.inner) } }

    /// Return `true` if this datatype declaration has been resolved.
    pub fn is_resolved(&self) -> bool { unsafe { cvc5_dt_decl_is_resolved(self.inner) } }

    /// Get the name of this datatype declaration.
    pub fn name(&self) -> &str {
        unsafe { std::ffi::CStr::from_ptr(cvc5_dt_decl_get_name(self.inner)).to_str().unwrap_or("") }
    }
}
...
impl PartialEq for DatatypeDecl {
    fn eq(&self, other: &Self) -> bool { unsafe { cvc5_dt_decl_is_equal(self.inner, other.inner) } }
}
impl Eq for DatatypeDecl {}

impl std::hash::Hash for DatatypeDecl {
    fn hash<H: std::hash::Hasher>(&self, state: &mut H) { unsafe { cvc5_dt_decl_hash(self.inner) }.hash(state); }
}

impl fmt::Debug for DatatypeDecl {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result { write!(f, "DatatypeDecl({self})") }
}
...
impl DatatypeSelector {
    pub(crate) fn from_raw(raw: Cvc5DatatypeSelector) -> Self { Self { inner: raw } }
    ...
    pub fn name(&self) -> &str {
        unsafe { std::ffi::CStr::from_ptr(cvc5_dt_sel_get_name(self.inner)).to_str().unwrap_or("") }
    }

    /// Get the selector function as a term.
    pub fn term(&self) -> Term { Term::from_raw(unsafe { cvc5_dt_sel_get_term(self.inner) }) }

    /// Get the updater function as a term.
    pub fn updater_term(&self) -> Term { Term::from_raw(unsafe { cvc5_dt_sel_get_updater_term(self.inner) }) }

    /// Get the codomain (return) sort of this selector.
    pub fn codomain_sort(&self) -> Sort { Sort::from_raw(unsafe { cvc5_dt_sel_get_codomain_sort(self.inner) }) }
}
...
impl PartialEq for DatatypeSelector {
    fn eq(&self, other: &Self) -> bool { unsafe { cvc5_dt_sel_is_equal(self.inner, other.inner) } }
}
impl Eq for DatatypeSelector {}

impl std::hash::Hash for DatatypeSelector {
    fn hash<H: std::hash::Hasher>(&self, state: &mut H) { unsafe { cvc5_dt_sel_hash(self.inner) }.hash(state); }
}

impl fmt::Debug for DatatypeSelector {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result { write!(f, "DatatypeSelector({self})") }
}
...
impl DatatypeConstructor {
    pub(crate) fn from_raw(raw: Cvc5DatatypeConstructor) -> Self { Self { inner: raw } }

    /// Get the name of this constructor.
    pub fn name(&self) -> &str {
        unsafe { std::ffi::CStr::from_ptr(cvc5_dt_cons_get_name(self.inner)).to_str().unwrap_or("") }
    }

    /// Get the constructor function as a term.
    pub fn term(&self) -> Term { Term::from_raw(unsafe { cvc5_dt_cons_get_term(self.inner) }) }
    ...
    pub fn tester_term(&self) -> Term { Term::from_raw(unsafe { cvc5_dt_cons_get_tester_term(self.inner) }) }

    /// Get the number of selectors of this constructor.
    pub fn num_selectors(&self) -> usize { unsafe { cvc5_dt_cons_get_num_selectors(self.inner) } }
...
impl PartialEq for DatatypeConstructor {
    fn eq(&self, other: &Self) -> bool { unsafe { cvc5_dt_cons_is_equal(self.inner, other.inner) } }
}
impl Eq for DatatypeConstructor {}

impl std::hash::Hash for DatatypeConstructor {
    fn hash<H: std::hash::Hasher>(&self, state: &mut H) { unsafe { cvc5_dt_cons_hash(self.inner) }.hash(state); }
}

impl fmt::Debug for DatatypeConstructor {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result { write!(f, "DatatypeConstructor({self})") }
}
...
impl Datatype {
    pub(crate) fn from_raw(raw: Cvc5Datatype) -> Self { Self { inner: raw } }
    ...
    pub fn name(&self) -> &str {
        unsafe { std::ffi::CStr::from_ptr(cvc5_dt_get_name(self.inner)).to_str().unwrap_or("") }
    }

    /// Get the number of constructors.
    pub fn num_constructors(&self) -> usize { unsafe { cvc5_dt_get_num_constructors(self.inner) } }
    ...
    pub fn is_parametric(&self) -> bool { unsafe { cvc5_dt_is_parametric(self.inner) } }

    /// Return `true` if this is a codatatype.
    pub fn is_codatatype(&self) -> bool { unsafe { cvc5_dt_is_codatatype(self.inner) } }

    /// Return `true` if this is a tuple datatype.
    pub fn is_tuple(&self) -> bool { unsafe { cvc5_dt_is_tuple(self.inner) } }

    /// Return `true` if this is a record datatype.
    pub fn is_record(&self) -> bool { unsafe { cvc5_dt_is_record(self.inner) } }

    /// Return `true` if this datatype is finite.
    pub fn is_finite(&self) -> bool { unsafe { cvc5_dt_is_finite(self.inner) } }

    /// Return `true` if this datatype is well-founded.
    pub fn is_well_founded(&self) -> bool { unsafe { cvc5_dt_is_well_founded(self.inner) } }
}
...
impl PartialEq for Datatype {
    fn eq(&self, other: &Self) -> bool { unsafe { cvc5_dt_is_equal(self.inner, other.inner) } }
}
impl Eq for Datatype {}

impl std::hash::Hash for Datatype {
    fn hash<H: std::hash::Hasher>(&self, state: &mut H) { unsafe { cvc5_dt_hash(self.inner) }.hash(state); }
}

impl fmt::Debug for Datatype {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result { write!(f, "Datatype({self})") }
}
