...
impl TermManager {
    ...
    pub fn mk_array_sort(&self, index: Sort, elem: Sort) -> Result<Sort<'_>> {
    ...
    pub fn mk_dt_sort(&self, decl: &DatatypeDecl) -> Result<Sort<'_>> {
        let raw = unsafe { mk_dt_sort(self.ptr(), decl.inner) };
        wrap(raw, "mk_dt_sort")
    }

    /// Create mutually recursive datatype sorts from declarations.
    pub fn mk_dt_sorts(&self, decls: &[DatatypeDecl]) -> Result<Vec<Sort<'_>>> {
    ...
    pub fn mk_fun_sort(&self, domain: &[Sort], codomain: Sort) -> Result<Sort<'_>> {
    ...
    pub fn mk_predicate_sort(&self, sorts: &[Sort]) -> Result<Sort<'_>> {
    ...
    pub fn mk_record_sort(&self, names: &[&str], sorts: &[Sort]) -> Result<Sort<'_>> {
    ...
    pub fn mk_abstract_sort(&self, k: cvc5_sys::SortKind) -> Result<Sort<'_>> {
    ...
    pub fn mk_tuple_sort(&self, sorts: &[Sort]) -> Result<Sort<'_>> {
        let raw: Vec<cvc5_sys::Sort> = sorts.iter().map(|s| s.inner).collect();
    ...
    pub fn mk_nullable_sort(&self, sort: Sort) -> Result<Sort<'_>> {
    ...
    pub fn mk_op(&self, kind: cvc5_sys::Kind, indices: &[u32]) -> Result<Op<'_>> {
    ...
    pub fn mk_op_from_str(&self, kind: cvc5_sys::Kind, arg: &str) -> Result<Op<'_>> {
    ...
    pub fn mk_term(&self, kind: cvc5_sys::Kind, children: &[Term]) -> Result<Term<'_>> {
    ...
    pub fn mk_term_from_op(&self, op: Op, children: &[Term]) -> Result<Term<'_>> {
        let raw: Vec<cvc5_sys::Term> = children.iter().map(|t| t.inner).collect();
    ...
    pub fn mk_tuple(&self, terms: &[Term]) -> Result<Term<'_>> {
    ...
    pub fn mk_nullable_is_null(&self, term: Term) -> Result<Term<'_>> {
    ...
    pub fn mk_nullable_is_some(&self, term: Term) -> Result<Term<'_>> {
    ...
    pub fn mk_nullable_null(&self, sort: Sort) -> Result<Term<'_>> {
        let raw = unsafe { mk_nullable_null(self.ptr(), sort.inner) };
        wrap(raw, "mk_nullable_null")
    }

    /// Lift an operator over nullable arguments.
    pub fn mk_nullable_lift(&self, kind: cvc5_sys::Kind, args: &[Term]) -> Result<Term<'_>> {
    ...
    pub fn mk_skolem(&self, id: cvc5_sys::SkolemId, indices: &[Term]) -> Result<Term<'_>> {
    ...
    pub fn mk_integer_from_str(&self, s: &str) -> Result<Term<'_>> {
    ...
    pub fn mk_real_from_str(&self, s: &str) -> Result<Term<'_>> {
        let c = CString::new(s).unwrap();
    ...
    pub fn mk_real_from_rational(&self, num: i64, den: i64) -> Result<Term<'_>> {
    ...
    pub fn mk_sep_nil(&self, sort: Sort) -> Result<Term<'_>> {
    ...
    pub fn mk_ff_elem(&self, value: &str, sort: Sort, base: u32) -> Result<Term<'_>> {
    ...
    pub fn mk_fp(&self, exp: u32, sig: u32, val: Term) -> Result<Term<'_>> {
    ...
    pub fn mk_fp_from_ieee(&self, sign: Term, exp: Term, sig: Term) -> Result<Term<'_>> {
    ...
    pub fn mk_cardinality_constraint(&self, sort: Sort, upper_bound: u32) -> Result<Term<'_>> {
    ...
    pub fn mk_const(&self, sort: Sort, name: &str) -> Result<Term<'_>> {
        let c = CString::new(name).unwrap();
    ...
    pub fn mk_anonymous_const(&self, sort: Sort) -> Result<Term<'_>> {
    ...
    pub fn mk_var(&self, sort: Sort, name: &str) -> Result<Term<'_>> {
        let c = CString::new(name).unwrap();
    ...
    pub fn mk_anonymous_var(&self, sort: Sort) -> Result<Term<'_>> {
    ...
    pub fn mk_string_from_wchar(&self, s: &[wchar_t]) -> Result<Term<'_>> {
    ...
    pub fn mk_string_from_char32(&self, s: &[char32_t]) -> Result<Term<'_>> {
