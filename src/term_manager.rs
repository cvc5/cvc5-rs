...
impl TermManager {
    ...
    pub fn mk_abstract_sort(&self, k: Cvc5SortKind) -> Sort<'_> {
    ...
    pub fn mk_op(&self, kind: Cvc5Kind, indices: &[u32]) -> Op<'_> {
    ...
    pub fn mk_op_from_str(&self, kind: Cvc5Kind, arg: &str) -> Op<'_> {
    ...
    pub fn mk_term(&self, kind: Cvc5Kind, children: &[Term]) -> Term<'_> {
    ...
    pub fn mk_nullable_lift(&self, kind: Cvc5Kind, args: &[Term]) -> Term<'_> {
    ...
    pub fn mk_skolem(&self, id: Cvc5SkolemId, indices: &[Term]) -> Term<'_> {
    ...
    pub fn mk_rm(&self, rm: Cvc5RoundingMode) -> Term<'_> {
